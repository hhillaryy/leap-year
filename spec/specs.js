describe("leapYear", function () {
  ...
  it("is null for an entry that is not a number", function() {
    expect(leapYear("hello")).to.equal(null);
  });

  it("is null for an entry that is a negative number", function(){
    expect(leapYear(-2000)).to.equal(null);
